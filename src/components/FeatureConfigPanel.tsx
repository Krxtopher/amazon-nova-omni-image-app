                    ...
                    <div>
                        ...
                        <div className="grid gap-4">
                            <div className="border rounded-lg p-4">
                                <h4 className="font-medium mb-2">Word Timing</h4>
                                <div className="grid grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <div className="flex gap-2">
                                            <input
                                                ...
                                                min="10"
                                                max="500"
                                                value={streamingConfig.wordDisplay.baseDelay.min}
                                                onChange={(e) => updateConfig({
                                                    wordDisplay: {
                                                        ...streamingConfig.wordDisplay,
                                                        baseDelay: {
                                                            ...streamingConfig.wordDisplay.baseDelay,
                                            ...
                                            <input
                                                ...
                                                min="10"
                                                max="500"
                                                value={streamingConfig.wordDisplay.baseDelay.max}
                                                onChange={(e) => updateConfig({
                                                    wordDisplay: {
                                                        ...streamingConfig.wordDisplay,
                                                        baseDelay: {
                                    ...
                                    <div>
                                        <Label className="text-sm">Fade Duration (ms)</Label>
                                        <div className="flex gap-2">
                                            <input
                                                type="number"
                                                min="50"
                                                max="1000"
                                                value={streamingConfig.wordDisplay.fadeInDuration.min}
                                                onChange={(e) => updateConfig({
                                                    wordDisplay: {
                                                        ...streamingConfig.wordDisplay,
                                                        fadeInDuration: {
                                                            ...streamingConfig.wordDisplay.fadeInDuration,
                                                            min: parseInt(e.target.value)
                                                        }
                                                    }
                                                })}
                                            ...
                                            <input
                                                ...
                                                min="50"
                                                max="1000"
                                                value={streamingConfig.wordDisplay.fadeInDuration.max}
                                                onChange={(e) => updateConfig({
                                                    wordDisplay: {
                                                        ...streamingConfig.wordDisplay,
                                                        fadeInDuration: {
